import 'package:vermithor/core/data/local/sembast/sembast_client.dart';
import 'package:vermithor/data/local/constants/db_constants.dart';
...
//  Future<Database> get _db async => await AppDatabase.instance.database;
  ...
  Future<PostList> getPostsFromDb() async {
    ...
    // post list
    PostList postsList = PostList(posts: []);
